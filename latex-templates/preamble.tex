...
\addbibresource{
    ~/git/Misc-LaTeX-files/bib/general.bib
}
\addbibresource{
    ~/git/Misc-LaTeX-files/bib/math-books.bib
}
...
\setkomafont{date}{\normalsize}
\setkomafont{section}{\light\Large}
\setkomafont{subsection}{\light\large}
