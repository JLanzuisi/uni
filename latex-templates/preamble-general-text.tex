...
\setmainfont[Numbers=OldStyle]{Libertinus Sans}
\newfontfamily{\tfont}[Ligatures=TeX]{Libertinus Serif}
...
\setkomafont{subtitle}{\normalfont\tfont\large\scshape}
\setkomafont{author}{\normalsize}
\setkomafont{date}{\normalsize}
\setkomafont{section}{\fontseries{m}\tfont\Large}
