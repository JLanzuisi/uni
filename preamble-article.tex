...
% \usepackage[osf,scaled=.95]{sourceserifpro} 
\usepackage{cfr-lm} 
% \usepackage{classico} 
% \usepackage[osf,scaled=.95]{sourcesanspro} 
\usepackage[l]{zlmtt} 
...
\newcommand{\dispfont}{\fontfamily{URWClassico-LF}\selectfont} 
\frenchspacing
...
\def\@maketitle{%
  ...
  \begin{flushleft}\dispfont
	...
	% \usebox{\tmpbox}%
	  {\Large\@title\marginnote{\parbox{3cm}{\raggedright\@author}}\par}
	\smallskip
	  {\Asignatura\ (0\the\month-\the\year)\par}
  	% \vskip 1em
  	% {}\par
	% {}\par
  \end{flushleft}
