...
\setmonofont[RawFeature={+liga}]{JetBrains Mono}
...
\newcommand{\nota}[1]{\refstepcounter{nota}\textsuperscript{\thenota}%
	\marginpar{%
		\parbox{3.5cm}{\raggedright\itshape\thenota. #1}%
	}
}
...
\def\@maketitle{%
  ...
  \begin{center}\sffamily
	...
	% \usebox{\tmpbox}%
	  {\large\textsc{\MakeLowercase{\@title}}\marginnote{\parbox{3cm}{\raggedright\normalfont\@author}}\par}
	\smallskip
	  {\small\itshape\Asignatura\ (0\the\month-\the\year)\par}
  	% \vskip 1em
  	% {}\par
	% {}\par
  \end{center}
